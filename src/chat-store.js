...
function buildGroupContact(group, existingContact = {}) {
  ...
  return {
    ...
    creatorId: group.creatorId ?? existingContact.creatorId ?? '',
    creatorUid: group.creatorUid ?? existingContact.creatorUid ?? '',
    ownerId: group.ownerId ?? existingContact.ownerId ?? '',
    ownerUid: group.ownerUid ?? existingContact.ownerUid ?? '',
    hostId,
    hostUid: hostId,
    adminId: group.adminId ?? existingContact.adminId ?? '',
    adminUid: group.adminUid ?? existingContact.adminUid ?? '',
    adminIds,
    adminUids: adminIds,
    messages: existingContact.messages ?? []
  };
